...
import 'package:ksfood/screens/merchant/widgets/product_list_tile.dart';
    ...
    return BlocBuilder<CartBloc, CartState>(
      ...
      builder: (context, state) {
        switch (state.status) {
          ...
          // final List<CartItem> items = state.carts!.map((doc) {
          ...
          //                 physics: const NeverScrollableScrollPhysics(),
          //                 itemBuilder: (context, index) {
          //                   final Product item = carts[index].items[index].product;
          //                   return ListTile(
          //                     onTap: () {},
          //                     leading: ClipRRect(
          //                       borderRadius: BorderRadius.circular(
